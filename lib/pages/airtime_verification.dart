...
class AirtimeVerificationPage extends StatefulWidget {
  const AirtimeVerificationPage({Key? key}) : super(key: key);

  @override
  State<AirtimeVerificationPage> createState() =>
      _AirtimeVerificationPageState();
}

class _AirtimeVerificationPageState extends State<AirtimeVerificationPage> {
